...
includes = ['readline', 'ipython', 'numpy', 'scipy', 'matplotlib', 'pytz', 'wx',
            'periodictable', 'bumps', 'refl1d', 'pygments', 
            'scipy.special._ufuncs_cxx', 'scipy.linalg.cython_blas', 'scipy.linalg.cython_lapack', 
            'scipy.sparse.csgraph._validation', 'scipy.spatial.ckdtree', 'scipy.spatial.*', 'scipy.spatial.transform.*',
            'scipy._lib.messagestream', 'scipy.special.cython_special',
            'pygments.lexers.*', 'pygments.styles.default']
