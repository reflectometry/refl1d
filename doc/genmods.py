...
MODULES = [
    ...
    ("probe.data_loaders.snsdata", "SNS Data"),
    ("probe.data_loaders.staj", "Staj File"),
    ("probe.data_loaders.stajconvert", "Staj File Converter"),
    ("probe.fresnel", "Pure python Fresnel reflectivity calculator"),
    ("probe.instrument", "Reflectivity instrument definition"),
    ("probe.resolution", "Beam resolution calculations"),
    ("probe.stitch", "Overlapping reflectivity curve stitching"),
    ...
    ("sample.magnetism", "Magnetic Models"),
    ...
    ("uncertainty", "Plot sample profile uncertainty"),
