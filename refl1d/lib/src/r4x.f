...
C R4XA(Q,N,D,S,P,EXPTH,AGUIDE,A,B,C,D) returns the complex amplitude r
...
C generate the routine R4XA rather than R4X
...
#ifdef AMPLITUDE
      subroutine R4XA(N,D,RHO,MU,LAMBDA,AGUIDE,P,EXPTH,Q,YA,YB,YC,YD)
#else
      subroutine R4X (N,D,RHO,MU,LAMBDA,AGUIDE,P,EXPTH,Q,RA,RB,RC,RD)
#endif
      implicit none

C     paramters
      integer N,I,L,FIRST,LAST,STEP
