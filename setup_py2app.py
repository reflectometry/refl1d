...
packages = []
includes = ["readline", "IPython", "numpy", "scipy", "matplotlib", "pytz", "wx", "periodictable", "bumps", "refl1d"]
...
py2app_opt = dict(
    argv_emulation=True, packages=packages, includes=includes, excludes=excludes, iconfile=ICON, optimize=2
)
options = dict(
    py2app=py2app_opt,
)
